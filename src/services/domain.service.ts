            ...
            if (localDomain) {
                ...
                if (rdashResponse.success && rdashResponse.data) {
                    ...
                    try {
                        ...
                        console.log('[DEBUG] Rdash Response Data Keys:', Object.keys(rdashResponse.data));
                        if (rdashResponse.data.registrant) console.log('[DEBUG] Registrant Data:', rdashResponse.data.registrant);
                        if (rdashResponse.data.admin) console.log('[DEBUG] Admin Data:', rdashResponse.data.admin);
                        else console.log('[DEBUG] Admin Data NOT FOUND in Rdash response');
